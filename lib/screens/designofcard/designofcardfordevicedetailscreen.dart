            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: _cardInfo(chipText1, chipText2,
                    LightColor.titleTextColor, chipColor, widths, functions),
              )
            ],
          ),
        ),
...
Widget _cardInfo(String title, String courses, Color textColor, Color primary,
    double width, List<Map<String,Object>> functions) {
  return Align(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        Container(width:width,child:Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [        ...functions.map((func) {
           return 
      RawMaterialButton(
        
      fillColor: Color.fromRGBO(255, 66, 85, 1),
      ...
      onPressed: func['functiontoexecute'],
      shape: const StadiumBorder(),
    );
          // return FlatButton(onPressed: func['functiontoexecute'], child: Text(func['name'] as String));
        }).toList()],))
...
List<Map<String, Object>> listofcontainers = [
  {
    ...
    'backWidget': decorationContainerA(LightColor.lightOrange, 50, -30),
  ...
  },
  {
    ...
    'chipColor': LightColor.seeBlue,
    'backWidget': decorationContainerD(LightColor.darkseeBlue, -100, -65,
  ...
  },
  {
    ...
    'backWidget':
        decorationContainerF(LightColor.lightOrange, LightColor.orange, 50, -30)
  }
];
